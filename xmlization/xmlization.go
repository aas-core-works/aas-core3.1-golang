...
import (
	...
	"encoding/xml"
	"fmt"
	aasreporting "github.com/aas-core-works/aas-core3.1-golang/reporting"
...
const Namespace = "https://admin-shell.io/aas/3/1"
...
func readEntityAsSequence(
	...
	for {
		...
		case "entityType":
			var value aastypes.EntityType
			value, current, valueErr = readTextAsEntityType(
				decoder,
				current,
			)
			theEntityType = &value
