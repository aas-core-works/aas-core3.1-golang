...
import (
	"fmt"
	aascommon "github.com/aas-core-works/aas-core3.1-golang/common"
	aasconstants "github.com/aas-core-works/aas-core3.1-golang/constants"
...
func constructMatchesXsAnyURI() *regexp.Regexp {
	...
	hex4 := "[0-9A-Fa-f]{1,4}"
	hexseq := aascommon.Concat(
		hex4,
		"(:",
		hex4,
		")*",
	)
	hexpart := aascommon.Concat(
		"(",
		hexseq,
		"|",
		hexseq,
	...
	ipv6reference := aascommon.Concat(
		"\\[",
		ipv6address,
		"\\]",
	)
