...
[![CI](https://github.com/aas-core-works/aas-core3.1-golang/actions/workflows/ci.yml/badge.svg)](https://github.com/aas-core-works/aas-core3.1-golang/actions/workflows/ci.yml)

[![CI-for-dev-scripts](https://github.com/aas-core-works/aas-core3.1-golang/actions/workflows/ci-for-dev-scripts.yml/badge.svg)](https://github.com/aas-core-works/aas-core3.1-golang/actions/workflows/ci-for-dev-scripts.yml)

[![Coverage Status](https://coveralls.io/repos/github/aas-core-works/aas-core3.1-golang/badge.svg?branch=main)](https://coveralls.io/github/aas-core-works/aas-core3.1-golang?branch=main)
...
[API documentation]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang
...
The SDK is available as a module `github.com/aas-core-works/aas-core3.1-golang`.

Install it using `go get`:

```
go get github.com/aas-core-works/aas-core3.1-golang
```
...
[`types`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types
...
[`types.IClass`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IClass
[`types.NewEnvironment`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#NewEnvironment
[`types.Environment`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#Environment
...
[`types.Environment.Submodels`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#Environment.Submodels
...
[`types.Blob.Value`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#Blob.Value
...
[`types.IHasKind.kindOrDefault`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IHasKind
...
(See: [Example CreateAnEnvironmentWithASubmodel](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-CreateAnEnvironmentWithASubmodel))
...
[`types.ModelType`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#ModelType
...
[`types.IsSubmodelElement`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IsSubmodelElement
[`types.IsProperty`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IsProperty
[`types.IsBlob`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IsBlob
...
(See: [Example IsXxx](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-IsXxx))
...
[`DescendOnce` and `Descend`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IClass
...
(See: [Example IterateOverEnvironment](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-IterateOverEnvironment))
...
[`stringification.ModellingKindToString`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/stringification#ModellingKindToString
[`stringification.MustModellingKindToString`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/stringification#MustModellingKindToString
...
[`types.ModelingKind`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/stringification#ModellingKindToString
[`types.LiteralsOfModellingKind`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#pkg-variables
...
(See: [Example IterateOverEnumerationLiterals](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-IterateOverEnumerationLiterals))
...
[`verification`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/verification
[`verification.Verify`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/verification#Verify
...
(See: [Example Verification](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-Verification))
...
[`jsonization`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/jsonization
...
[`jsonization.ToJsonable`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/jsonization#ToJsonable
...
(See: [Example JsonizationTo](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-JsonizationTo))
...
[`types.IEnvironment`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#IEnvironment
[`jsonization.EnvironmentFromJsonable`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/jsonization#EnvironmentFromJsonable
...
import (
	...
	"fmt"
	aasjsonization "github.com/aas-core-works/aas-core3.1-golang/jsonization"
	aasstringification "github.com/aas-core-works/aas-core3.1-golang/stringification"
	aastypes "github.com/aas-core-works/aas-core3.1-golang/types"
)
...
(See: [Example JsonizationFrom](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-JsonizationFrom))

### XML de/serialization

The de/serialization of the AAS models is handled by the package [`xmlization`].

[`xmlization`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/xmlization
...
(See: [Example XmlizationTo](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-XmlizationTo))
...
[`xmlization.Unmarshal`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/xmlization#Unmarshal
...
func main() {
	text := `<environment xmlns="https://admin-shell.io/aas/3/1">
  <submodels>
    <submodel>
      <id>some-unique-global-identifier</id>
      <submodelElements>
...
(See: [Example XmlizationFrom](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-XmlizationFrom))
...
(See: [Example XmlizationFromTextWithBOMAndXMLDeclaration](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-XmlizationFromTextWithBOMAndXMLDeclaration))
...
(See: [Example XmlizationSkipAttributes](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-XmlizationSkipAttributes))
...
func main() {
	...
	xmlns:aas="https://admin-shell.io/aas/3/1"
>
  <aas:submodels>
    <aas:submodel>
...
(See: [Example XmlizationNamespaceAlias](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-XmlizationNamespaceAlias))
...
[`types.ISubmodel`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#ISubmodel
[`types.ISubmodelElement`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/types#ISubmodelElement
...
[`enhancing`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/enhancing
...
[`enhancing.Wrap`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/enhancing#Wrap
[`enhancing.Unwrap`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/enhancing#Unwrap
[`enhancing.MustUnwrap`]: https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/enhancing#MustUnwrap
...
import (
	"fmt"
	aasenhancing "github.com/aas-core-works/aas-core3.1-golang/enhancing"
	aastypes "github.com/aas-core-works/aas-core3.1-golang/types"
)
...
(See: [Example EnhancingParentChild](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-EnhancingParentChild))
...
(See: [Example EnhancingReferable](https://pkg.go.dev/github.com/aas-core-works/aas-core3.1-golang/getting_started#example-package-EnhancingReferable))
...
[create an issue]: https://github.com/aas-core-works/aas-core3.1-golang/issues/new
...
[creating GitHub issues]: https://github.com/aas-core-works/aas-core3.1-golang/issues/new/choose
...
[create a new issue]: https://github.com/aas-core-works/aas-core3.1-golang/issues/new/choose
...
The test data is automatically generated by [aas-core-testdatagen], and copied to this repository on every change.
...
### v1.0.0-rc1 (2026-03-04)

This is the initial version, ready for first tests.
