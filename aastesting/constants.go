...
const RecordModeEnvironmentVariableName string = ("GITHUB_COM_AAS_CORE_WORKS_AAS_CORE3_1_GOLANG_TEST_RECORD_MODE")
...
const TestDataDirEnvironmentVariableName string = ("GITHUB_COM_AAS_CORE_WORKS_AAS_CORE3_1_GOLANG_TEST_DATA_DIR")
