...
func deepEqualRelationshipElement(
	...
	if (thatFirst == nil && otherFirst != nil) ||
		(thatFirst != nil && otherFirst == nil) {
		return false
	}
	if thatFirst != nil {
		if !DeepEqual(
	...
	if (thatSecond == nil && otherSecond != nil) ||
		(thatSecond != nil && otherSecond == nil) {
		return false
	}
	if thatSecond != nil {
		if !DeepEqual(
...
func deepEqualEntity(
	...
	if (thatEntityType == nil && otherEntityType != nil) ||
		(thatEntityType != nil && otherEntityType == nil) {
		return false
	}
	if thatEntityType != nil {
